...
{    
    ...
    public ComponentShapeBox ()                                             { initialize ( 0.0,   0.0,   0.0,   0.0   ); }
    public ComponentShapeBox ( double[] v0, double[] v1 )                   { initialize ( v0[X], v0[Y], v1[X], v1[Y] ); }
    public ComponentShapeBox ( double x0, double y0, double x1, double y1 ) { initialize ( x0,    y0,    x1,    y1    ); }
